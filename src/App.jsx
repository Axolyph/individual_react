...
const catalogoCompleto = [
  { id: 1, name: "Auriculares InalÃ¡mbricos Pro", price: "98.95", category: "Electronicos", rating: "4.8", inStock: true, discount: "15%", shortDesc: "CancelaciÃ³n de ruido activa y baterÃ­a de 40 horas continuas.", image: auriculares },
  { id: 2, name: "iPhone 14 PRO Max", price: "2500.00", category: "Electronicos", rating: "4.9", inStock: true, discount: null, shortDesc: "Pantalla Super Retina XDR y sistema de cÃ¡maras profesional.", image: iphone },
  { id: 3, name: "Smartwatch Sport Elite", price: "545.00", category: "Electronicos", rating: "4.7", inStock: true, discount: "10%", shortDesc: "Monitoreo cardÃ­aco avanzado y GPS integrado multimodo.", image: smartwatch },
  { id: 4, name: "Chaqueta de Cuero Legacy", price: "180.00", category: "Ropa", rating: "4.9", inStock: true, discount: null, shortDesc: "Cuero genuino texturizado con acabados metÃ¡licos premium.", image: chaqueta },
  ...
  { id: 6, name: "Auriculares Wave Buds", price: "45.00", category: "Electronicos", rating: "4.4", inStock: true, discount: "20%", shortDesc: "Ajuste seguro ergonÃ³mico ideal para entrenamientos de alta intensidad.", image: auriculares },
  { id: 7, name: "Laptop HP Pavilion 16", price: "3200.00", category: "Electronicos", rating: "4.8", inStock: true, discount: null, shortDesc: "Procesador de Ãºltima generaciÃ³n y pantalla micro-edge ultranÃ­tida.", image: iphone },
  ...
  { id: 9, name: "Camisa Slim Fit Tropical", price: "65.00", category: "Ropa", rating: "4.7", inStock: true, discount: null, shortDesc: "AlgodÃ³n premium respirable con patrÃ³n moderno de verano.", image: chaqueta },
  { id: 10, name: "Billetera Carbon Protect", price: "55.00", category: "Accesorios", rating: "4.9", inStock: true, discount: "30%", shortDesc: "Fibra de carbono real con bloqueo RFID anti-clonaciÃ³n.", image: mochila },
      ...
      <main>
        ...
        <section id="productos" className="container" style={{ paddingBottom: '5rem' }}>
          ...
          <p className="section-subtitle" style={{ textAlign: 'center', color: 'var(--text-muted)', marginBottom: '2.5rem' }}>
            Explora las mejores propuestas tecnolÃ³gicas y de moda urbana.
          </p>
